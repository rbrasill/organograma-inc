...
export function validarLinhas(linhas, { matriculasBanco = new Set(), situacoesValidas = null, situacoesCodigos = null, colunas = null } = {}) {
  ...
  const anotadas = linhas.map((l) => {
    ...
    return { ...l, tipo, existente, liderValido, nascISO, admISO, status, erros, alertas };
  });
